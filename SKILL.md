...
### 8. LangChain Complete
**File:** `08_[ModelName]_LangChain_Complete.ipynb`

**Basics:** LLM integration, prompt templates, chains, memory, loaders
**Intermediate:** Retrieval chains, agents, output parsers
**Advanced:** LCEL, function agents, callbacks, LangSmith

---

### 9. LangGraph Complete
**File:** `09_[ModelName]_LangGraph_Complete.ipynb`

**Basics:** Graphs, nodes, edges, state, conditional routing
**Intermediate:** Agent loops, human-in-loop, persistence
**Advanced:** Multi-agent patterns, workflows, streaming
